...
{description:**[$username[$authorID]#$discriminator[$authorID]](https://discord.com/users/$authorID)** adlı kişi **Yardım** konulu bir canlı destek oluşturdu.}{color:4B81FC}{thumbnail:$userAvatar[$clientID]}{timestamp}};true]]
$title[📁 Canlı Destek]
$color[#4B81FC]
$addTimestamp
...
$sendDm[{newEmbed:{title:📁 Canlı Destek}{timestamp}{color:4B81FC}{thumbnail:$userAvatar[$authorID]}{description:**Yardım** konulu destek talebiniz yetkililerimize gönderildi. Lütfen geri dönütün gelmesini bekleyiniz. DM kutucuğunuz açık kalmalı aksi taktirde desteğin onaylanıp onaylanmadığını göremezsiniz.}};$authorID;false]
...
$pinMessage[$get[mesaj];$get[canli]]
$let[mesaj;$channelSendMessage[$get[canli];{newEmbed:{title:📁 Canlı Destek}
{description:**[$username[$authorID]#$discriminator[$authorID]](https://discord.com/users/$authorID)** adlı kişi **Premium** konulu bir canlı destek oluşturdu.}{color:4B81FC}{thumbnail:$userAvatar[$clientID]}{timestamp}};true]]
$title[📁 Canlı Destek]
$color[#4B81FC]
$addTimestamp
$description[Canlı destek Eğer onaylanırsa konuşma başlayacak ve bu destekte konuşulanlar kayıt altına alınacak. Canlı destek onaylanmazsa bu kanal kapatılacak ve konuşma yaşanmayacak. Canlı destek onaylansın mı?]
...
$pinMessage[$get[mesaj];$get[canli]]
$let[mesaj;$channelSendMessage[$get[canli];{newEmbed:{title:📁 Canlı Destek}
{description:**[$username[$authorID]#$discriminator[$authorID]](https://discord.com/users/$authorID)** adlı kişi **$textInputValue[konu]** konulu bir canlı destek oluşturdu.}{color:4B81FC}{thumbnail:$userAvatar[$clientID]}{timestamp}};true]]
$title[📁 Canlı Destek]
$color[#4B81FC]
$addTimestamp
$description[Canlı destek Eğer onaylanırsa konuşma başlayacak ve bu destekte konuşulanlar kayıt altına alınacak. Canlı destek onaylanmazsa bu kanal kapatılacak ve konuşma yaşanmayacak. Canlı destek onaylansın mı?]
...
$useChannel[$get[canli]]
$let[canli;$createChannel[$getVar[sunucu];$username-$discriminator;Text;true;$getVar[yetkilikategori]]]
$sendDm[{newEmbed:{title:📁 Canlı Destek}{timestamp}{color:4B81FC}{thumbnail:$userAvatar[$authorID]}{description:**$textInputValue[konu]** konulu destek talebiniz yetkililerimize gönderildi. Lütfen geri dönütün gelmesini bekleyiniz. DM kutucuğunuz açık kalmalı aksi taktirde desteğin onaylanıp onaylanmadığını göremezsiniz.}};$authorID;false]
...
$channelSendMessage[$getVar[gecmis];{newEmbed:{title:📁 Canlı Destek}{description:**[$username[$getChannelVar[kullanici;$channelID]]#$discriminator[$getChannelVar[kullanici;$channelID]]](https://discord.com/users/$getChannelVar[kullanici;$channelID])** adlı kişinin **$getGlobalUserVar[konu;$getChannelVar[kullanici;$channelID]]** konulu canlı destek talebi <@$authorID> tarafından sonlandırıldı.}{color:#4B81FC}{timestamp}{thumbnail:$userAvatar[$clientID]}}]
$sendDm[{newEmbed:{title:📁 Canlı Destek}{timestamp}{color:4B81FC}{thumbnail:$userAvatar[$authorID]}{description:**$getGlobalUserVar[konu;$getChannelVar[kullanici;$channelID]]** konulu destek talebiniz <@$authorID> adlı yetkilimiz tarafından sonlandırıldı.}};$getChannelVar[kullanici;$channelID];false]
$interactionUpdate[;{newEmbed:{title:📁 Canlı Destek}{description:**$getGlobalUserVar[konu;$getChannelVar[kullanici;$channelID]]** konulu destek talebi <@$authorID> tarafından sonlandırıldı. Bu kanal **10 Saniye** sonra kapanacak ve geçmişe gönderilecek.}{color:4B81FC}{timestamp}{thumbnail:$userAvatar[$clientID]}};{actionRow:{button:Kapat:danger:kapat:true:❌}}]
